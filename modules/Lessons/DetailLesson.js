...
export default function DetailLesson() {
    ...
    useEffect(async () => {
        ...
        const stateData = {
            ...state,
            ...data.data,
            lessonContent: data.data.lessonContent ? data.data.lessonContent : '',
        };
            ...
            <div className="border-2">
                ...
                <div className={'relative flex-col min-w-0 break-words w-full mb-6 shadow-lg bg-white px-6 justify-center flex'}>
                    <div className="w-full px-4 2xl:flex mt-4 mb-6 h-full">
                        ...
                        <div className="2xl:w-7/12 w-full px-4 py-4 items-center 2xl:text-base text-xs text-blueGray-700 ">
