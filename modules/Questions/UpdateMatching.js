...
export default function UpdateMatching({ lessonId, data }) {
                        ...
                        <div className="w-full px-4 justify-center items-center">
                            <div className="relative w-full items-center flex">
                                    ...
                                    <div className="w-full px-4 mb-6">
                                        <div className="relative w-full mb-3 items-center fex px-4">
                                            ...
                                            <div className="text-base border h-auto w-full p-4">
                                                {state.typeAnswerLeft == 'text'
                                                    ? renderLatex(dt.left.content)
                                                    : null}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    hidden={state.typeAnswerLeft == 'image' ? false : true}
                                >
                                    <Upload
                                        listType="picture-card"
                                        customRequest={({ file, onSuccess, onError }) =>
                                            uploadImage(file, onSuccess, onError, 'left')
                                        }
                                        showUploadList={false}
                                    >
                                        {dt.left.imageUrl ? (
                                            <img
                                                src={dt.left.imageUrl}
                                                alt="avatar"
                                                style={{ width: '100%' }}
                                            />
                                        ) : (
                    ...
                    <div className="w-5/12 items-center flex p-2 border">
                        <div className="w-full px-4 justify-center items-center">
                            <div className="relative w-full items-center flex">
                                ...
                                >
                                    ...
                                    <div className="w-full px-4 mb-6">
                                        <div className="relative w-full mb-3 items-center fex px-4">
                                            ...
                                            <div className="text-base border h-auto w-full p-4">
                                                {state.typeAnswerRight == 'text'
                                                    ? renderLatex(dt.right.content)
                                                    : null}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    className="w-8/12 ml-4"
                                    hidden={state.typeAnswerRight == 'image' ? false : true}
                                >
                                    <Upload
                                        listType="picture-card"
                                        customRequest={({ file, onSuccess, onError }) =>
                                            uploadImage(file, onSuccess, onError, 'right')
                                        }
                                        showUploadList={false}
                                    >
                                        {dt.right.imageUrl ? (
                                            <img
                                                src={dt.right.imageUrl}
                                                alt="avatar"
                                                style={{ width: '100%' }}
                                            />
                                        ) : (
    ...
    useEffect(async () => {
        ...
        data.typeAnswerLeft = data.answers[0] ? data.answers[0].typeAnswerLeft : null;
        data.typeAnswerRight = data.answers[0] ? data.answers[0].typeAnswerRight : null;
        data.audioInfo = [
            {
                url: data.audio,
                name: data.audioName,
        ...
        setState(data);
        const zoneArr = data.answers[0] ? data.answers[0].content : [];
        setZones(zoneArr);
        dispatch(loadingFalse());
    }, [data]);
    ...
    async function onUpdate() {
        ...
        const body = {
            ...
            answers: {
                content: zones,
                correct: true,
                typeAnswerLeft: state.typeAnswerLeft,
                typeAnswerRight: state.typeAnswerRight,
            },
            lessonId,
        };
        const rs1 = await serviceHelpers.updateData('questions/matching', data.id, body);
