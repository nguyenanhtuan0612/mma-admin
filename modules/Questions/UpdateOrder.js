...
export default function UpdateOrder({ data, lessonId }) {
    ...
    useEffect(async () => {
        ...
        setState(data);
        console.log(data);
        setZones(data.answers[0].content);
        dispatch(loadingFalse());
    }, []);
    ...
    async function onUpdate() {
        ...
        //console.log(body);
        const rs1 = await serviceHelpers.updateData('questions/order', data.id, body);
            ...
            <div className="border-2">
                <div className={'relative flex flex-col min-w-0 break-words w-full shadow-lg rounded-t bg-blueGray-100'}>
                    <div className=" px-6 align-middle text-sm whitespace-nowrap p-4 text-center flex items-center justify-center">
                        <b className="text-xl font-semibold leading-normal text-blueGray-700">Câu hỏi sắp xếp</b>
                    </div>
                </div>
