    ...
    return (function () {
                ...
                function e(e) {
                    ...
                    h))
                        if (h.hasOwnProperty(t)) {
                            var r = h[t];
                            this[t] =
                                void 0 !== e[t] ? (r.processor ? r.processor(e[t]) : e[t]) : m(r);
                        }
                }
                var t = e.prototype;
                return (
        ...
        var Ht = function (e) {
            ...
            Gt = function (e, t) {
                var r = (function () {
                    ...
                    i = r.height;
                return (
                    (n.height = i), (n.style.height = V(i)), a > 0 && (n.style.minWidth = V(a)), n
                );
            };
        function Ut(e, t) {
            if (!e || e.type !== t)
        ...
        ot({
            ...
            mathmlBuilder: function (e, t) {
                var r,
                    n = Vt(e.label);
                if (
                    (n.setAttribute('minsize', 'x' === e.label.charAt(0) ? '1.75em' : '3.0em'),
                    e.body)
                ) {
                    var a = $t(Rt(e.body, t));
                    if (e.below) {
        ...
        var Yr = function (e, t) {
                ...
                for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
                    ...
                    if (!(a >= s)) {
                        ...
                        (a > 0 || e.hskipBeforeAndAfter) &&
                            ...
                            (((C = Ke.makeSpan(['arraycolsep'], [])).style.width = V(W)),
                            R.push(C));
                        var _ = [];
                        for (r = 0; r < i; ++r) {
                            var j = h[r],
            ...
            Wr = function (e, t) {
                ...
                return (
                    ...
                    '' !== c &&
                        (h = new Tt.MathNode('menclose', [h])).setAttribute('notation', c.trim()),
                    e.arraystretch &&
                        e.arraystretch < 1 &&
            ...
            nn = function (e, t) {
                ...
                if (
                    ...
                    u - o.depth - (w + 0.5 * m) < p && (u += p - (u - o.depth - (w + 0.5 * m))),
                        w - 0.5 * m - (y.height - d) < p &&
                            (d += p - (w - 0.5 * m - (y.height - d)));
                    var k = -(w - 0.5 * m);
                    f = Ke.makeVList(
                        {
                            positionType: 'individualShift',
                ...
                return (
                    ...
                    (v =
                        null == e.leftDelim
                            ? xt(t, ['mopen'])
                            : Ar.customSizedDelim(e.leftDelim, g, !0, t.havingStyle(n), e.mode, [
                                  'mopen',
                              ])),
                    (b = e.continued
                        ? Ke.makeSpan([])
                        : null == e.rightDelim
                        ? xt(t, ['mclose'])
                        : Ar.customSizedDelim(e.rightDelim, g, !0, t.havingStyle(n), e.mode, [
                              'mclose',
                          ])),
                    Ke.makeSpan(
        ...
        var cn = function (e, t, r, n, a, i, o) {
            ...
            pn = function (e, t) {
                ...
                var o,
                    ...
                    h = !1;
                if (
                    (s.size === x.DISPLAY.size && a.symbol && !l.contains(un, a.name) && (h = !0),
                    a.symbol)
                ) {
        ...
        ot({
            ...
            ot({
                ...
                htmlBuilder: function (e, t) {
                    for (
                        var r = qn(e), n = [], a = t.havingStyle(t.style.text()), i = 0;
                        i < r.length;
                        i++
                    ) {
                        var o = r[i];
            ...
            Gn = (function () {
                ...
                return (
                    ...
                    (t.scanArgument = function (e) {
                        ...
                        return (
                            this.pushToken(new Dr('EOF', r.loc)), this.pushTokens(n), t.range(r, '')
                        );
                    }),
            ...
            Xn = (function () {
                ...
                return (
                    ...
                    (t.parseExpression = function (t, r) {
                        ...
                        return (
                            'text' === this.mode && this.formLigatures(n), this.handleInfixNodes(n)
                        );
                    }),
